      ...
      <ul className="navbar-nav ml-auto ">
                 ...
                 {currentUser && (
                   ...
                   <div style={{display:"flex",marginTop:"15px"}}>
                     ...
                     <Link to="/" style={{color:"black"}}> <i className="far fa-home-lg-alt fa-2x"></i> </Link>
                   
                    
                     {/* <i className="far fa-plus-square fa-2x" style={{marginRight:"20px"}} onClick={() => setShow(true)} ></i> */}
                
                         <Link to="/jobs"> <i className="fas fa-shopping-bag fa-2x"></i></Link>
                     
               
                     <Link to="/chat"> <i className="fad fa-comments-alt fa-2x"></i></Link>
                  
                  
                     <Link to="/mynetwork">  <i className="fas fa-user-friends fa-2x"></i></Link>
                   
                
                    <Link to="/notification">  <i className="fas fa-bell fa-2x"></i></Link>
